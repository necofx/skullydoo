/*
# $Id: vtkFlRenderWindowInteractor.cxx,v 1.1 2003/05/02 22:21:54 sebasfiorent Exp $
...
void vtkFlRenderWindowInteractor::Delete(){
	if (parent()) ((Fl_Group*)parent())->remove(*(Fl_Gl_Window*)this);
	vtkFlRenderWindowInteractor::Delete();
}
//---------------------------------------------------------------------------
void vtkFlRenderWindowInteractor::Initialize()
{
    ...
    // enable everythi ng and start rendering
    Enable();
