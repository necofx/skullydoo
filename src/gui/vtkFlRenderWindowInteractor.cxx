/*
* vtkFlRenderWindowInteractor - class to enable VTK to render
to and interact with a FLTK window.
* 
...
//---------------------------------------------------------------------------
vtkFlRenderWindowInteractor::vtkFlRenderWindowInteractor( int x, int y,
